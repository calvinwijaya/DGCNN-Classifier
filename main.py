...
from PyQt5.QtWidgets import (QApplication, QWidget, QPushButton, QVBoxLayout, 
                             ...
                             QWidget, QComboBox, QDoubleSpinBox, QProgressBar, QMessageBox)
...
class ProcessThread(QThread):
    ...
    def run(self):
        try:
            ...
            # Emit signal with success=True if return_code==0
...
class PointCloudClassificationGUI(QWidget):
    ...
    def start_process(self):
        ...
        self.process_thread.finished_signal.connect(self.process_finished)  # Call a function when the process finishes
